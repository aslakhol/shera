  ...
  return (
    <div className="flex justify-center">
      <div className="flex w-8/12 flex-col justify-center gap-3 pb-8 pt-2 md:w-1/2">
        ...
        <p className="py-4 leading-7 [&:not(:first-child)]:mt-6">
            ...
            <tbody>
              <tr className="m-0 border-t p-0 even:bg-muted">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  ...
                  profile on the app, and show you and other users on your
                  events and events you are attending.
                </td>
              </tr>
              <tr className="m-0 border-t p-0 even:bg-muted">
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  We use this information to contact you to send you updates
                  about your events and events you are attending.
                </td>
              </tr>
              <tr className="m-0 border-t p-0 even:bg-muted">
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  We use this data to provide you and your guests with
                  information about your events, and inform you about events you
                  are attending.
                </td>
              </tr>
              <tr className="m-0 border-t p-0 even:bg-muted">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  We use this data to improve and develop our services.
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr className="m-0 border-t p-0 even:bg-muted">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  We store your contact data while you have an account with
                  shera, or you are attending any events.
                </td>
              </tr>
              <tr className="m-0 border-t p-0 even:bg-muted">
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
              ...
              <tr className="m-0 border-t p-0 even:bg-muted">
                ...
                <td className="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right">
                  This data is anonymized immediately.
                </td>
              </tr>
            </tbody>
          </table>
